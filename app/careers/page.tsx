    ...
    <div className="bg-white text-black">
      ...
      <section className="py-24 text-center border-b">
        <h1 className="text-5xl md:text-7xl font-black tracking-tight">
          Careers at <span className="bg-[linear-gradient(108deg,#0079d0_0%,#9e52d8_32%,#da365c_84%,#d04901_100%)] bg-clip-text text-transparent">Our Company</span>
        </h1>
        <p className="mt-6 text-gray-500 max-w-2xl mx-auto text-lg">
          We are building high-performance digital products. Join us and grow with a team that values execution and impact.
        </p>
      </section>
