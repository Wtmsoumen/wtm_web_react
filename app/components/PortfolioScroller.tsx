...
const portfolioItems = [
  ...
  },
  {
    ...
    category: "Travel",
    image: "/images/portfilio/transform_mart.webp",
  ...
  },
  {
    ...
    image: "/images/portfilio/transform_stickybiz.webp",
        ...
        >
          {items.map((item, idx) => (
            ...
            >
              ...
              {/* <div className="absolute top-0 left-0 right-0 h-8 bg-white/90 backdrop-blur-sm flex items-center px-3 gap-1.5 z-10">
                <div className="w-2.5 h-2.5 rounded-full bg-red-400" />
                <div className="w-2.5 h-2.5 rounded-full bg-yellow-400" />
                <div className="w-2.5 h-2.5 rounded-full bg-green-400" />
                <div className="flex-1 mx-3 h-4 bg-gray-200 rounded-full" />
              </div> */}
