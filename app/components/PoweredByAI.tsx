        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6 mb-10">
            <div data-aos="fade-right">
              {/* Badge */}
              <div className={`${globalStyle?.gradientText} inline-flex items-center gap-1.5 text-md font-semibold px-5 py-3 rounded-full mb-4`}>
            ...
            {/* View All */}
            <div className="md:self-end" data-aos="fade-left">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
            {solutions.map((item, idx) => {
              ...
              return (
                <div
                  key={item.id}
                  className="relative bg-white border border-gray-100 rounded-2xl py-8 pl-5 pr-3 flex flex-col gap-3 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-pointer group"
                  data-aos="fade-up"
