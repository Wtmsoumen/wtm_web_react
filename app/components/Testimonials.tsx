          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {displayed.map((t, idx) => (
              ...
              >
                ...
                {/* Highlight */}
                <div
                  className={`inline-block text-xs font-bold bg-linear-to-r ${t.color} bg-clip-text text-transparent mb-4`}
                >
                  📈 {t.highlight}
                </div>
                ...
                <div className="flex items-center gap-3 border-t border-white/10 pt-4">
                  <div
                    className={`w-10 h-10 rounded-full bg-linear-to-br ${t.color} flex items-center justify-center text-white font-bold text-sm shrink-0`}
                  >
                    {t.avatar}
                  </div>
                  <div>
