...
//   return (
//     <section className=" relative max-h-screen flex items-center justify-center bg-[#060d1b] overflow-hidden pt-16">
...
//             >
//               <div className={`text-5xl font-bold mb-2 ${globalStyle?.gradientText} bg-clip-text text-transparent`}>
//                 {stat.value}
//               </div>
