...
const teamData = [
    {
        ...
        members: [
            ...
            { name: "Neha Singh", role: "Director", image: neha, social: true },
                        ...
                        <div key={catIdx} className="mb-24">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                                {category.members.map((member, memIdx) => (
                                    ...
                                    >
                                        <div className="relative aspect-[4/5] overflow-hidden rounded-[1.5rem] bg-gray-50 mb-4">
                                            <Image 
                                                src={member.image} 
                                                alt={member.name} 
                                            ...
                                            />
                                            {member.social && (
                                                <div className="absolute inset-0 bg-linear-to-t from-red-600/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
